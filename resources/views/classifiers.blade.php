...
<style type="text/css">
          ...
          <div class="card-body">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td>{{++$index}}</td>
                  <td><img style="height:34px;width:48px; " src="{{$classifier->image}}"></td>
  ...
  <div class="row">
    ...
    <div class="modal fade" id="classifier-modal" style="display: none;" aria-hidden="true">
      <div class="modal-dialog">
        <form class="form-horizontal" method="post" action="{{url('/classifier/create')}}" enctype="multipart/form-data">
          @csrf
  ...
  <div class="row">
    ...
    <div class="modal fade" id="classifier-edit-modal{{$classifier->id}}" style="display: none;" aria-hidden="true">
      <div class="modal-dialog">
        <form class="form-horizontal" method="post" action="{{url('/classifier/edit/'.$classifier->id)}}"  enctype="multipart/form-data">
          @csrf
          <div class="modal-content">
            <div class="modal-body pb-0">
             <div class="card card-info">
